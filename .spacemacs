  ...
  (unless window-system
    ...
    (defun open-editor-file ()
      ...
      (cond
       ;; In buffers with file names
       ((buffer-file-name)
        (shell-command (concat "deepin-editor " buffer-file-name)))
       ;; In dired-mode
       ((eq major-mode 'dired-mode)
        (shell-command (concat "deepin-editor " (dired-current-directory))))
       ;; fallback to default-directory
       (t
        (shell-command (concat "deepin-editor "  default-directory)))
       ))
